...
# -*- coding: utf-8 -*-
"""
generate_presentation_cli_openai.py
=====================================
...
(API de OpenAI) para estructurar el contenido.
...
EJEMPLOS DE USO:
    ...
    python generate_presentation_cli_openai.py \\
        --input practica.docx \\
    ...
    python generate_presentation_cli_openai.py -i practica.docx -o salida.pptx --save-json

    # Modo detallado (debug)
    python generate_presentation_cli_openai.py -i practica.docx -o salida.pptx --verbose
...
def construir_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="generate_presentation_cli_openai.py",
        description=(
            "Genera una presentación .pptx con estilo académico profesional "
            "a partir de un documento .docx, utilizando un modelo de "
            "lenguaje (API de OpenAI) para estructurar el contenido."
        ),
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Ejemplo:\n"
            "  python generate_presentation_cli_openai.py -i practica.docx "
            "-o presentacion.pptx --model gpt-4o --max-tokens 16000\n"
        ),
    )
    ...
    parser.add_argument(
        ...
        default="gpt-4o",
        help=(
            "Modelo de OpenAI a utilizar (por defecto: 'gpt-4o'). "
            "Otras opciones habituales: 'gpt-4.1' (contexto muy amplio), "
            "'gpt-4o-mini' (más rápido y económico) o los modelos de "

...
CONFIGURACION_POR_DEFECTO = {
    "input": "/Users/rafa/Programas/tmp/salida/resultados_claude-sonnet-4-6.md",
    "output": "/Users/rafa/Programas/tmp/salida/documento_final1.docx",
    "tema": "default",
    "ancho": 1200,
    "alto": 800,
    "escala": 2.0,
...
def comprobar_sistema_operativo() -> str:
    """
    Devuelve una descripción amigable del sistema operativo actual.
    """
...
def main() -> int:
    ...
    print("=" * 70 + "\n")
    print(f"Sistema operativo detectado: {comprobar_sistema_operativo()}")

...
if __name__ == "__main__":
    ...
    practica_docente = leer_fichero_markdown("/Users/rafa/Programas/tmp/resultados_claude-sonnet-4-6.md")
    system_prompt = """
    ...
    if cuenta_tokens:
        ...
        name_file = "/Users/rafa/Programas/tmp/resultados_solved_" + resultado['modelo'] + ".md"
